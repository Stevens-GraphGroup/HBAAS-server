package com.java.maven.test.wrap;
...
//the output should really be ranges instead of strings
    ...
    public static String taxToRaw(Connector conn, String taxon,String hmm_path_file) throws AccumuloSecurityException, AccumuloException, TableNotFoundException
    {
        long startTime = System.currentTimeMillis();

        System.load("/home/dren/Senior_D/Wrap.so");
        Wrap wrap = new Wrap();
        String hmm_path = "/home/dren/Senior_D/"+ hmm_path_file;
...
*/
                ...
                rawSeq= new HashMap<String,String>();
...
*/
       ...
       String data =  taxon + "  " + Integer.toString(counter) + " " +  Long.toString(totalTime-computeTime) + " " + Long.toString(computeTime);
